...
class DatabaseHelper{
  ...
  Future<Database> database() async{
    return openDatabase(
      ...
      onCreate: (db, version) {
         db.execute('CREATE TABLE tasks(id INTEGER PRIMARY KEY, title TEXT, description TEXT)');
         db.execute('CREATE TABLE todo(id INTEGER PRIMARY KEY, taskId INTEGER, title TEXT, isDone INTEGER)');
        print("create tables");
        return db;
      },
      version: 1,
